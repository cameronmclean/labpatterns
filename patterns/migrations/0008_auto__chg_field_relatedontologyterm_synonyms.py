...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RelatedOntologyTerm.synonyms'
        db.alter_column(u'ontology_terms', 'synonyms', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'RelatedOntologyTerm.synonyms'
        db.alter_column(u'ontology_terms', 'synonyms', self.gf('django.db.models.fields.CharField')(max_length=255))
